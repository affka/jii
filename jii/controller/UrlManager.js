 ...
 */
var self = Joints.defineClass('Jii.controller.UrlManager', Jii.base.Component, {
    ...
    setHostInfo: function (value) {
        this._hostInfo = _.rtrim(value, '/');
    }

}, {

    buildQuery: function (obj, temp_key) {
        var outputs = [];
        var cleanRegexp = /[!'()*]/g;
        ...
        _.each(obj, function(value, key) {
            ...
            if (_.isObject(value)) {
                outputs.push(self.buildQuery(value, key))
            } else {
