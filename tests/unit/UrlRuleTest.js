...
var self = Joints.defineClass('tests.unit.UrlRuleTest', Jii.base.UnitTest, {
    ...
    createUrlTest__: function (test) {
        ...
        _.each(suites, function(suite, i) {
            ...
            var rule = new Jii.controller.UrlRule(config);
            _.each(tests, function(urlTest, j) {
                var route = urlTest[0];
        ...
        _.each(suites, function(suite, i) {
            ...
            _.each(tests, function(urlTest, j) {
                ...
                if (route === false) {
                    ...
                    test.deepEqual(result, [route, params], 'Test #' + i + '-' + j + ': ' + name);
                }
            });
        });
    ...
    _getTestsForCreateUrl: function () {
        ...
        return [
            ...
            ['without param', {pattern: 'posts', route: 'post\/index'}, [
                ['post\/index', {}, 'posts'],
                ['comment\/index', {}, false],
                ['post\/index', {page: 1}, 'posts?page=1']
            ]],
            ['parsing only', {pattern: 'posts', route: 'post\/index', mode: Jii.controller.UrlRule.PARSING_ONLY}, [
                ['post\/index', {}, false]
            ]],
            ['with param', {pattern: 'post/<page>', route: 'post/index'}, [
                ['post\/index', {}, false],
                ['comment\/index', {}, false],
                ['post\/index', {page: 1}, 'post\/1'],
                ['post\/index', {page: 1, tag: 'a'}, 'post\/1?tag=a']
            ]],
            ['with param requirement', {pattern: 'post/<page:\\d+>', route: 'post/index'}, [
                ['post\/index', {page: 'abc'}, false],
                ['post\/index', {page: 1}, 'post\/1'],
                ['post\/index', {page: 1, tag: 'a'}, 'post\/1?tag=a']
            ]],
            ['with multiple params', {pattern: 'post/<page:\\d+>-<tag>', route: 'post\/index'}, [
                ['post\/index', {page: '1abc'}, false],
                ['post\/index', {page: 1}, false],
                ['post\/index', {page: 1, tag: 'a'}, 'post\/1-a']
            ]],
            ['with optional param', {pattern: 'post/<page:\\d+>/<tag>', route: 'post\/index', defaults: {page: 1}}, [
                ['post\/index', {page: 1}, false],
                ['post\/index', {page: '1abc', tag: 'a'}, false],
                ['post\/index', {page: 1, tag: 'a'}, 'post/a'],
                ['post\/index', {page: 2, tag: 'a'}, 'post/2/a']
            ]],
            ['with optional param not in pattern', {pattern: 'post/<tag>', route: 'post\/index', defaults: {page: 1}}, [
                ['post\/index', {page: 1}, false],
                ['post\/index', {page: '1abc', tag: 'a'}, false],
                ['post\/index', {page: 2, tag: 'a'}, false],
                ['post\/index', {page: 1, tag: 'a'}, 'post\/a']
            ]],
            ['multiple optional params', {pattern: 'post/<page:\\d+>/<tag>/<sort:yes|no>', route: 'post\/index', defaults: {page: 1, sort: 'yes'}}, [
                ['post\/index', {page: 1}, false],
                ['post\/index', {page: '1abc', tag: 'a'}, false],
            ...
            ['optional param and required param separated by dashes', {pattern: 'post/<page:\\d+>-<tag>', route: 'post\/index', defaults: {page: 1}}, [
                ['post\/index', {page: 1}, false],
                ['post\/index', {page: '1abc', tag: 'a'}, false],
                ['post\/index', {page: 1, tag: 'a'}, 'post\/-a'],
                ['post\/index', {page: 2, tag: 'a'}, 'post\/2-a']
            ]],
            ['optional param at the end', {pattern: 'post/<tag>/<page:\\d+>', route: 'post\/index', defaults: {page: 1}}, [
                ['post\/index', {page: 1}, false],
                ['post\/index', {page: '1abc', tag: 'a'}, false],
                ['post\/index', {page: 1, tag: 'a'}, 'post\/a'],
            ...
            ['route has parameters', {pattern: '<controller>/<action>', route: '<controller>/<action>', defaults: {}}, [
                ['post\/index', {page: 1}, 'post\/index?page=1'],
                ['module\/post\/index', {}, false]
            ]],
            ['route has parameters with regex', {pattern: '<controller:post|comment>/<action>', route: '<controller>/<action>', defaults: {}}, [
                ['post\/index', {page: 1}, 'post\/index?page=1'],
            ...
            ['route has default parameter', {pattern: '<controller:post|comment>/<action>', route: '<controller>/<action>', defaults: {action: 'index'}}, [
            ...
            ['empty pattern with suffix', {pattern: '', route: 'post\/index', suffix: '.html'}, [
                ['post\/index', {}, ''],
                ['comment\/index', {}, false],
                ['post\/index', {page: 1}, '?page=1']
            ]],
            ['regular pattern with suffix', {pattern: 'posts', route: 'post\/index', suffix: '.html'}, [
                ['post\/index', {}, 'posts.html'],
                ['comment\/index', {}, false],
                ['post\/index', {page: 1}, 'posts.html?page=1']
            ]],
            ['empty pattern with slash suffix', {pattern: '', route: 'post\/index', suffix: '\/'}, [
                ['post\/index', {}, ''],
                ['comment\/index', {}, false],
                ['post\/index', {page: 1}, '?page=1']
            ]],
            ['regular pattern with slash suffix', {pattern: 'posts', route: 'post\/index', suffix: '\/'}, [
                ['post\/index', {}, 'posts\/'],
                ['comment\/index', {}, false],
                ['post\/index', {page: 1}, 'posts\/?page=1']
            ]],
            ['with host info', {pattern: 'post/<page:\\d+>/<tag>', route: 'post\/index', defaults: {page: 1}, host: 'http://<lang:en|fr>.example.com'}, [
    ...
    _getTestsForParseRequest: function () {
        ...
        return [
            ...
            ['with dot', {pattern: 'posts.html', route: 'post\/index'}, [
                ['posts.html', 'post\/index'],
                ['postsahtml', false]
            ]],
            ['creation only', {pattern: 'posts', route: 'post\/index', mode: Jii.controller.UrlRule.CREATION_ONLY}, [
                ['posts', false]
            ]],
            ['with param', {pattern: 'post\/<page>', route: 'post\/index'}, [
            ...
            ['with host info', {pattern: 'post\/<page:\\d+>', route: 'post\/index', host: 'http://<lang:en|fr>.example.com'}, [
